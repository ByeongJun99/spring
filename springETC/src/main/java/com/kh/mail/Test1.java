 ...
 * 	  (gmail의 SMTP를 이요하기 위해서는 IMAP를 사용으로 해줘야한다.)
 */
public class Test1 {
	public static void main(String[] args) {
		...
		sender.setPort(587);
		sender.setUsername("qndqnd2232@gmail.com");
		sender.setPassword("valj byew inhi bqtz");
		
		// 옵션설정
		Properties prop = new Properties();
		prop.put("mail.smtp.auth", true);	// SMTP의 보안 사용
